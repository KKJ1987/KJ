...
public class ex06입장료계산프로그램연습 {


	public static void main(String[] args) {

		// 0. 입력도구 꺼내오기 ( 한번만 꺼내오면 계속 사용가능 )
		Scanner sc = new Scanner(System.in);
				
				// 1. 출력
		System.out.println("에버랜드환영");
		// 2. 나이 입력
		System.out.print("나이입력 >> ");
		int age = sc.nextInt();
		
		// 원하는 코드 복사 : 컨트롤 + 알트 누르고 방향키
		...
		int result = 0; // else 문에 생긴 result 값을 부여하기 위해 만들어준거
		if(age<20) {
